...
from routes import workers, pei, convenios, prio_rules, metrics, agendamentos, server_configs, lotes, conciliacao, protocolo, relatorios_rm, motivos_faltas, workflows, unidades
